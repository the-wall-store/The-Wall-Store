...
// 3) UPI PAYMENT DETAILS (fallback only)
// This is only used until you save real payment details from
// Admin Dashboard → Settings, which are then stored in Firestore
// (settings/payment) and take priority over these values. You can still
// leave a sensible fallback here in case that Firestore doc is ever empty.
const UPI_CONFIG = {
